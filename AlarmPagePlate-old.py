...
class Sensor(QtWidgets.QWidget):
    ...
    def settingname(self):
        ...
        self.sensorname.setStyleSheet("font-weight:bold;font-size:14px;")
        ...
        self.ftitle.setStyleSheet("font-size:14px")
    ...
    def settingProgressbar(self):
        ...
        step = (height-12) // 4
        self.Progressbar.setFixedHeight(270)
    ...
    def SettingValue(self):
        ...
        self.PVLine.setStyleSheet("background-color: green;")
